...
train_data = DataLoader(prepare_multi_sources_data.SSLR_Dataset(train_data_path), batch_size=16,
                        shuffle=True, num_workers=0)  # train_data is a tuple: (batch_x, batch_y)
test_data = DataLoader(prepare_multi_sources_data.SSLR_Dataset(test_data_path), batch_size=16,
